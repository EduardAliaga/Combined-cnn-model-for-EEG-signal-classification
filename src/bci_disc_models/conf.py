...
MODELS = [
    ...
    "disc-nn-combined-cnn",
    "disc-nn-combined-cnn-no-attention",
    "disc-nn-combined-cnn-no-attention-tiny",
    "disc-nn-combined-cnn-tiny",
    "disc-nn-transformer",
...
NAME_MODEL_KWARGS = []
for arch in ["eegnet", "simple-cnn-1d", "simple-cnn-2d", "combined-cnn","combined-cnn-no-attention-tiny","combined-cnn-tiny"]:
